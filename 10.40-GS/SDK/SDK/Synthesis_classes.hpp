...
static_assert(sizeof(UModularSynthComponent) == 0x000C80, "Wrong size on UModularSynthComponent");
static_assert(offsetof(UModularSynthComponent, VoiceCount) == 0x000600, "Member 'UModularSynthComponent::VoiceCount' has a wrong offset!");
...
static_assert(sizeof(UGranularSynth) == 0x000950, "Wrong size on UGranularSynth");
static_assert(offsetof(UGranularSynth, GranulatedSoundWave) == 0x000600, "Member 'UGranularSynth::GranulatedSoundWave' has a wrong offset!");
...
static_assert(sizeof(USynthSamplePlayer) == 0x000730, "Wrong size on USynthSamplePlayer");
static_assert(offsetof(USynthSamplePlayer, SoundWave) == 0x000600, "Member 'USynthSamplePlayer::SoundWave' has a wrong offset!");
static_assert(offsetof(USynthSamplePlayer, OnSampleLoaded) == 0x000608, "Member 'USynthSamplePlayer::OnSampleLoaded' has a wrong offset!");
static_assert(offsetof(USynthSamplePlayer, OnSamplePlaybackProgress) == 0x000618, "Member 'USynthSamplePlayer::OnSamplePlaybackProgress' has a wrong offset!");
