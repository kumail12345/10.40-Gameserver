...
static_assert(sizeof(UAthenaMainStatTile_C) == 0x000250, "Wrong size on UAthenaMainStatTile_C");
static_assert(offsetof(UAthenaMainStatTile_C, Glow) == 0x000248, "Member 'UAthenaMainStatTile_C::Glow' has a wrong offset!");
