...
static_assert(sizeof(UGAT_Athena_PurpleStuff_C) == 0x000988, "Wrong size on UGAT_Athena_PurpleStuff_C");
static_assert(offsetof(UGAT_Athena_PurpleStuff_C, UberGraphFrame_GAT_Athena_PurpleStuff_C) == 0x000978, "Member 'UGAT_Athena_PurpleStuff_C::UberGraphFrame_GAT_Athena_PurpleStuff_C' has a wrong offset!");
static_assert(offsetof(UGAT_Athena_PurpleStuff_C, PlayerPawn) == 0x000980, "Member 'UGAT_Athena_PurpleStuff_C::PlayerPawn' has a wrong offset!");
