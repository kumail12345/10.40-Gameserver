...
static_assert(sizeof(FControlRigSequencerAnimInstanceProxy) == 0x000B30, "Wrong size on FControlRigSequencerAnimInstanceProxy");
...
static_assert(sizeof(FRigUnit_Example) == 0x0000D8, "Wrong size on FRigUnit_Example");
static_assert(offsetof(FRigUnit_Example, TestInputString) == 0x000040, "Member 'FRigUnit_Example::TestInputString' has a wrong offset!");
static_assert(offsetof(FRigUnit_Example, TestInOutTransform) == 0x000050, "Member 'FRigUnit_Example::TestInOutTransform' has a wrong offset!");
static_assert(offsetof(FRigUnit_Example, TestInputVector) == 0x000074, "Member 'FRigUnit_Example::TestInputVector' has a wrong offset!");
static_assert(offsetof(FRigUnit_Example, TestInputInteger) == 0x000080, "Member 'FRigUnit_Example::TestInputInteger' has a wrong offset!");
static_assert(offsetof(FRigUnit_Example, TestInputObject) == 0x000088, "Member 'FRigUnit_Example::TestInputObject' has a wrong offset!");
static_assert(offsetof(FRigUnit_Example, TestOutputVector) == 0x000090, "Member 'FRigUnit_Example::TestOutputVector' has a wrong offset!");
static_assert(offsetof(FRigUnit_Example, TestInputFloat) == 0x00009C, "Member 'FRigUnit_Example::TestInputFloat' has a wrong offset!");
static_assert(offsetof(FRigUnit_Example, TestInputFloatArray) == 0x0000A0, "Member 'FRigUnit_Example::TestInputFloatArray' has a wrong offset!");
static_assert(offsetof(FRigUnit_Example, TestInputTransformArray) == 0x0000B0, "Member 'FRigUnit_Example::TestInputTransformArray' has a wrong offset!");
static_assert(offsetof(FRigUnit_Example, TestOutputFloat) == 0x0000C0, "Member 'FRigUnit_Example::TestOutputFloat' has a wrong offset!");
static_assert(offsetof(FRigUnit_Example, TestUnitReferenceInput) == 0x0000C8, "Member 'FRigUnit_Example::TestUnitReferenceInput' has a wrong offset!");
static_assert(offsetof(FRigUnit_Example, TestUnitReferenceOutput) == 0x0000D0, "Member 'FRigUnit_Example::TestUnitReferenceOutput' has a wrong offset!");
...
static_assert(sizeof(FRigUnit_TwoBoneIKFK) == 0x000200, "Wrong size on FRigUnit_TwoBoneIKFK");
...
static_assert(offsetof(FRigUnit_TwoBoneIKFK, bUsePoleTarget) == 0x000050, "Member 'FRigUnit_TwoBoneIKFK::bUsePoleTarget' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKFK, PoleTarget) == 0x000054, "Member 'FRigUnit_TwoBoneIKFK::PoleTarget' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKFK, Spin) == 0x000060, "Member 'FRigUnit_TwoBoneIKFK::Spin' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKFK, EndEffector) == 0x000070, "Member 'FRigUnit_TwoBoneIKFK::EndEffector' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKFK, IKBlend) == 0x0000A0, "Member 'FRigUnit_TwoBoneIKFK::IKBlend' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKFK, StartJointFKTransform) == 0x0000B0, "Member 'FRigUnit_TwoBoneIKFK::StartJointFKTransform' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKFK, MidJointFKTransform) == 0x0000E0, "Member 'FRigUnit_TwoBoneIKFK::MidJointFKTransform' has a wrong offset!");
static_assert(offsetof(FRigUnit_TwoBoneIKFK, EndJointFKTransform) == 0x000110, "Member 'FRigUnit_TwoBoneIKFK::EndJointFKTransform' has a wrong offset!");
