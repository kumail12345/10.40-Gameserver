...
static_assert(sizeof(UGA_DefaultPlayer_InteractUse_C) == 0x000968, "Wrong size on UGA_DefaultPlayer_InteractUse_C");
static_assert(offsetof(UGA_DefaultPlayer_InteractUse_C, UberGraphFrame) == 0x000960, "Member 'UGA_DefaultPlayer_InteractUse_C::UberGraphFrame' has a wrong offset!");
