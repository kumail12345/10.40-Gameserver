...
static_assert(sizeof(UTabGameOptionsMain_C) == 0x0002A0, "Wrong size on UTabGameOptionsMain_C");
static_assert(offsetof(UTabGameOptionsMain_C, UberGraphFrame) == 0x000290, "Member 'UTabGameOptionsMain_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UTabGameOptionsMain_C, TooltipDisplayReference) == 0x000298, "Member 'UTabGameOptionsMain_C::TooltipDisplayReference' has a wrong offset!");
