...
static_assert(offsetof(UNiagaraComponent, Asset) == 0x0003C0, "Member 'UNiagaraComponent::Asset' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, OverrideParameters) == 0x0003C8, "Member 'UNiagaraComponent::OverrideParameters' has a wrong offset!");
...
static_assert(offsetof(UNiagaraComponent, PreviewDetailLevel) == 0x000564, "Member 'UNiagaraComponent::PreviewDetailLevel' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, PreviewLODDistance) == 0x000568, "Member 'UNiagaraComponent::PreviewLODDistance' has a wrong offset!");
...
static_assert(offsetof(UNiagaraDataInterfaceSkeletalMesh, SkinningMode) == 0x000080, "Member 'UNiagaraDataInterfaceSkeletalMesh::SkinningMode' has a wrong offset!");
static_assert(offsetof(UNiagaraDataInterfaceSkeletalMesh, SamplingRegions) == 0x000088, "Member 'UNiagaraDataInterfaceSkeletalMesh::SamplingRegions' has a wrong offset!");
static_assert(offsetof(UNiagaraDataInterfaceSkeletalMesh, WholeMeshLOD) == 0x000098, "Member 'UNiagaraDataInterfaceSkeletalMesh::WholeMeshLOD' has a wrong offset!");
static_assert(offsetof(UNiagaraDataInterfaceSkeletalMesh, SpecificBones) == 0x0000A0, "Member 'UNiagaraDataInterfaceSkeletalMesh::SpecificBones' has a wrong offset!");
static_assert(offsetof(UNiagaraDataInterfaceSkeletalMesh, SpecificSockets) == 0x0000B0, "Member 'UNiagaraDataInterfaceSkeletalMesh::SpecificSockets' has a wrong offset!");
...
static_assert(sizeof(UNiagaraParameterCollectionInstance) == 0x000138, "Wrong size on UNiagaraParameterCollectionInstance");
...
static_assert(offsetof(UNiagaraRibbonRendererProperties, CurveTension) == 0x00006C, "Member 'UNiagaraRibbonRendererProperties::CurveTension' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, TessellationMode) == 0x000070, "Member 'UNiagaraRibbonRendererProperties::TessellationMode' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, TessellationFactor) == 0x000074, "Member 'UNiagaraRibbonRendererProperties::TessellationFactor' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, bUseConstantFactor) == 0x000078, "Member 'UNiagaraRibbonRendererProperties::bUseConstantFactor' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, TessellationAngle) == 0x00007C, "Member 'UNiagaraRibbonRendererProperties::TessellationAngle' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, bScreenSpaceTessellation) == 0x000080, "Member 'UNiagaraRibbonRendererProperties::bScreenSpaceTessellation' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, PositionBinding) == 0x000088, "Member 'UNiagaraRibbonRendererProperties::PositionBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, ColorBinding) == 0x000118, "Member 'UNiagaraRibbonRendererProperties::ColorBinding' has a wrong offset!");
...
static_assert(offsetof(UNiagaraRibbonRendererProperties, RibbonTwistBinding) == 0x0002C8, "Member 'UNiagaraRibbonRendererProperties::RibbonTwistBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, RibbonWidthBinding) == 0x000358, "Member 'UNiagaraRibbonRendererProperties::RibbonWidthBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, RibbonFacingBinding) == 0x0003E8, "Member 'UNiagaraRibbonRendererProperties::RibbonFacingBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, RibbonIdBinding) == 0x000478, "Member 'UNiagaraRibbonRendererProperties::RibbonIdBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, RibbonLinkOrderBinding) == 0x000508, "Member 'UNiagaraRibbonRendererProperties::RibbonLinkOrderBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, MaterialRandomBinding) == 0x000598, "Member 'UNiagaraRibbonRendererProperties::MaterialRandomBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, DynamicMaterialBinding) == 0x000628, "Member 'UNiagaraRibbonRendererProperties::DynamicMaterialBinding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, DynamicMaterial1Binding) == 0x0006B8, "Member 'UNiagaraRibbonRendererProperties::DynamicMaterial1Binding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, DynamicMaterial2Binding) == 0x000748, "Member 'UNiagaraRibbonRendererProperties::DynamicMaterial2Binding' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, DynamicMaterial3Binding) == 0x0007D8, "Member 'UNiagaraRibbonRendererProperties::DynamicMaterial3Binding' has a wrong offset!");
...
static_assert(sizeof(UNiagaraScript) == 0x0006A8, "Wrong size on UNiagaraScript");
...
static_assert(offsetof(UNiagaraScript, ScriptExecutionParamStoreGPU) == 0x000250, "Member 'UNiagaraScript::ScriptExecutionParamStoreGPU' has a wrong offset!");
static_assert(offsetof(UNiagaraScript, CachedScriptVMId) == 0x000368, "Member 'UNiagaraScript::CachedScriptVMId' has a wrong offset!");
...
static_assert(offsetof(UNiagaraScript, CachedScriptVM) == 0x000580, "Member 'UNiagaraScript::CachedScriptVM' has a wrong offset!");
static_assert(offsetof(UNiagaraScript, CachedParameterCollectionReferences) == 0x000688, "Member 'UNiagaraScript::CachedParameterCollectionReferences' has a wrong offset!");
static_assert(offsetof(UNiagaraScript, CachedDefaultDataInterfaces) == 0x000698, "Member 'UNiagaraScript::CachedDefaultDataInterfaces' has a wrong offset!");
...
static_assert(offsetof(UNiagaraSystem, SystemSpawnScript) == 0x000050, "Member 'UNiagaraSystem::SystemSpawnScript' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, SystemUpdateScript) == 0x000058, "Member 'UNiagaraSystem::SystemUpdateScript' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, EmitterSpawnAttributes) == 0x000060, "Member 'UNiagaraSystem::EmitterSpawnAttributes' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, ExposedParameters) == 0x000070, "Member 'UNiagaraSystem::ExposedParameters' has a wrong offset!");
