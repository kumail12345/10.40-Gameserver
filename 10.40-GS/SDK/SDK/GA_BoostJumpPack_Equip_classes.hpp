...
static_assert(sizeof(UGA_BoostJumpPack_Equip_C) == 0x000970, "Wrong size on UGA_BoostJumpPack_Equip_C");
static_assert(offsetof(UGA_BoostJumpPack_Equip_C, UberGraphFrame) == 0x000960, "Member 'UGA_BoostJumpPack_Equip_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UGA_BoostJumpPack_Equip_C, PlayerPawn) == 0x000968, "Member 'UGA_BoostJumpPack_Equip_C::PlayerPawn' has a wrong offset!");
