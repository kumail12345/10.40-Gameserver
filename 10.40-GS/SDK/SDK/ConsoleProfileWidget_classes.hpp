...
static_assert(sizeof(UConsoleProfileWidget_C) == 0x000238, "Wrong size on UConsoleProfileWidget_C");
static_assert(offsetof(UConsoleProfileWidget_C, DisplayName) == 0x000228, "Member 'UConsoleProfileWidget_C::DisplayName' has a wrong offset!");
static_assert(offsetof(UConsoleProfileWidget_C, Prefix) == 0x000230, "Member 'UConsoleProfileWidget_C::Prefix' has a wrong offset!");
