...
static_assert(sizeof(UGAT_DanceGrenade_C) == 0x000988, "Wrong size on UGAT_DanceGrenade_C");
static_assert(offsetof(UGAT_DanceGrenade_C, UberGraphFrame_GAT_DanceGrenade_C) == 0x000978, "Member 'UGAT_DanceGrenade_C::UberGraphFrame_GAT_DanceGrenade_C' has a wrong offset!");
static_assert(offsetof(UGAT_DanceGrenade_C, PlayerPawn) == 0x000980, "Member 'UGAT_DanceGrenade_C::PlayerPawn' has a wrong offset!");
