...
static_assert(sizeof(UOptionsMenu_C) == 0x000650, "Wrong size on UOptionsMenu_C");
...
static_assert(offsetof(UOptionsMenu_C, CloseIcon) == 0x000358, "Member 'UOptionsMenu_C::CloseIcon' has a wrong offset!");
...
static_assert(offsetof(UOptionsMenu_C, MobileCloseButton) == 0x000378, "Member 'UOptionsMenu_C::MobileCloseButton' has a wrong offset!");
static_assert(offsetof(UOptionsMenu_C, OverlayCloseButton) == 0x000380, "Member 'UOptionsMenu_C::OverlayCloseButton' has a wrong offset!");
static_assert(offsetof(UOptionsMenu_C, OverlayText) == 0x000388, "Member 'UOptionsMenu_C::OverlayText' has a wrong offset!");
static_assert(offsetof(UOptionsMenu_C, SafeZone_0) == 0x000390, "Member 'UOptionsMenu_C::SafeZone_0' has a wrong offset!");
static_assert(offsetof(UOptionsMenu_C, SavingLayer) == 0x000398, "Member 'UOptionsMenu_C::SavingLayer' has a wrong offset!");
static_assert(offsetof(UOptionsMenu_C, SettingsTabs) == 0x0003A0, "Member 'UOptionsMenu_C::SettingsTabs' has a wrong offset!");
static_assert(offsetof(UOptionsMenu_C, Title) == 0x0003A8, "Member 'UOptionsMenu_C::Title' has a wrong offset!");
static_assert(offsetof(UOptionsMenu_C, VideoSettingsAccept) == 0x0003B0, "Member 'UOptionsMenu_C::VideoSettingsAccept' has a wrong offset!");
static_assert(offsetof(UOptionsMenu_C, VideoSettingsCancel) == 0x0003B8, "Member 'UOptionsMenu_C::VideoSettingsCancel' has a wrong offset!");
...
static_assert(offsetof(UOptionsMenu_C, NewControllerSettingsTab) == 0x000598, "Member 'UOptionsMenu_C::NewControllerSettingsTab' has a wrong offset!");
static_assert(offsetof(UOptionsMenu_C, ControllerSensitivity) == 0x0005C0, "Member 'UOptionsMenu_C::ControllerSensitivity' has a wrong offset!");
static_assert(offsetof(UOptionsMenu_C, ControllerSensitivityTabClass) == 0x000648, "Member 'UOptionsMenu_C::ControllerSensitivityTabClass' has a wrong offset!");
