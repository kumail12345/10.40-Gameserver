...
static_assert(sizeof(TeamMemberBanner_C_OpenPartyFinder) == 0x000020, "Wrong size on TeamMemberBanner_C_OpenPartyFinder");
...
static_assert(offsetof(TeamMemberBanner_C_OpenPartyFinder, CallFunc_GetContext_ReturnValue) == 0x000008, "Member 'TeamMemberBanner_C_OpenPartyFinder::CallFunc_GetContext_ReturnValue' has a wrong offset!");
static_assert(offsetof(TeamMemberBanner_C_OpenPartyFinder, K2Node_DynamicCast_AsSocial_Panel) == 0x000010, "Member 'TeamMemberBanner_C_OpenPartyFinder::K2Node_DynamicCast_AsSocial_Panel' has a wrong offset!");
static_assert(offsetof(TeamMemberBanner_C_OpenPartyFinder, K2Node_DynamicCast_bSuccess) == 0x000018, "Member 'TeamMemberBanner_C_OpenPartyFinder::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(TeamMemberBanner_C_OpenPartyFinder, CallFunc_ShouldShowExternalFriendsUI_ReturnValue) == 0x000019, "Member 'TeamMemberBanner_C_OpenPartyFinder::CallFunc_ShouldShowExternalFriendsUI_ReturnValue' has a wrong offset!");
static_assert(offsetof(TeamMemberBanner_C_OpenPartyFinder, CallFunc_IsActivated_ReturnValue) == 0x00001A, "Member 'TeamMemberBanner_C_OpenPartyFinder::CallFunc_IsActivated_ReturnValue' has a wrong offset!");
