...
static_assert(sizeof(UTextRotator_C) == 0x000BA8, "Wrong size on UTextRotator_C");
static_assert(offsetof(UTextRotator_C, UberGraphFrame) == 0x000B98, "Member 'UTextRotator_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UTextRotator_C, MainBorder) == 0x000BA0, "Member 'UTextRotator_C::MainBorder' has a wrong offset!");
