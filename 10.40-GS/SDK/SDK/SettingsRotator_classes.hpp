...
static_assert(sizeof(USettingsRotator_C) == 0x000BA8, "Wrong size on USettingsRotator_C");
static_assert(offsetof(USettingsRotator_C, UberGraphFrame) == 0x000B98, "Member 'USettingsRotator_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(USettingsRotator_C, Background) == 0x000BA0, "Member 'USettingsRotator_C::Background' has a wrong offset!");
