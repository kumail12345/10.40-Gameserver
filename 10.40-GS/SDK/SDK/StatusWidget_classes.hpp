...
static_assert(sizeof(UStatusWidget_C) == 0x000388, "Wrong size on UStatusWidget_C");
static_assert(offsetof(UStatusWidget_C, UberGraphFrame) == 0x000380, "Member 'UStatusWidget_C::UberGraphFrame' has a wrong offset!");
