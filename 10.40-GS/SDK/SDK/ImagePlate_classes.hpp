...
static_assert(sizeof(UImagePlateComponent) == 0x000490, "Wrong size on UImagePlateComponent");
static_assert(offsetof(UImagePlateComponent, Plate) == 0x0003C0, "Member 'UImagePlateComponent::Plate' has a wrong offset!");
...
static_assert(sizeof(UImagePlateFrustumComponent) == 0x0003C0, "Wrong size on UImagePlateFrustumComponent");
