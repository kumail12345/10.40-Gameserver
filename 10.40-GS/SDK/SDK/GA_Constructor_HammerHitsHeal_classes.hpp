...
static_assert(sizeof(UGA_Constructor_HammerHitsHeal_C) == 0x000AC0, "Wrong size on UGA_Constructor_HammerHitsHeal_C");
static_assert(offsetof(UGA_Constructor_HammerHitsHeal_C, UberGraphFrame_GA_Constructor_HammerHitsHeal_C) == 0x000A98, "Member 'UGA_Constructor_HammerHitsHeal_C::UberGraphFrame_GA_Constructor_HammerHitsHeal_C' has a wrong offset!");
static_assert(offsetof(UGA_Constructor_HammerHitsHeal_C, TC_RequiredTags) == 0x000AA0, "Member 'UGA_Constructor_HammerHitsHeal_C::TC_RequiredTags' has a wrong offset!");
