...
static_assert(offsetof(AthenaSeasonReward_C_SetState, Temp_bool_Variable_3) == 0x000011, "Member 'AthenaSeasonReward_C_SetState::Temp_bool_Variable_3' has a wrong offset!");
static_assert(offsetof(AthenaSeasonReward_C_SetState, K2Node_Select_Default_2) == 0x000012, "Member 'AthenaSeasonReward_C_SetState::K2Node_Select_Default_2' has a wrong offset!");
static_assert(offsetof(AthenaSeasonReward_C_SetState, K2Node_Select_Default_3) == 0x000013, "Member 'AthenaSeasonReward_C_SetState::K2Node_Select_Default_3' has a wrong offset!");
...
static_assert(offsetof(AthenaSeasonReward_C_SetState, Temp_float_Variable_1) == 0x000018, "Member 'AthenaSeasonReward_C_SetState::Temp_float_Variable_1' has a wrong offset!");
static_assert(offsetof(AthenaSeasonReward_C_SetState, Temp_bool_Variable_4) == 0x00001C, "Member 'AthenaSeasonReward_C_SetState::Temp_bool_Variable_4' has a wrong offset!");
static_assert(offsetof(AthenaSeasonReward_C_SetState, K2Node_Select_Default_4) == 0x000020, "Member 'AthenaSeasonReward_C_SetState::K2Node_Select_Default_4' has a wrong offset!");
