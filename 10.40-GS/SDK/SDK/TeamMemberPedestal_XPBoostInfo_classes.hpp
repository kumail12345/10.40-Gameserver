...
static_assert(sizeof(UTeamMemberPedestal_XPBoostInfo_C) == 0x000B90, "Wrong size on UTeamMemberPedestal_XPBoostInfo_C");
static_assert(offsetof(UTeamMemberPedestal_XPBoostInfo_C, UberGraphFrame) == 0x000B80, "Member 'UTeamMemberPedestal_XPBoostInfo_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UTeamMemberPedestal_XPBoostInfo_C, PrimaryOvr) == 0x000B88, "Member 'UTeamMemberPedestal_XPBoostInfo_C::PrimaryOvr' has a wrong offset!");
