...
static_assert(sizeof(WebPurchase_C_Dismiss) == 0x000010, "Wrong size on WebPurchase_C_Dismiss");
...
static_assert(offsetof(WebPurchase_C_Dismiss, CallFunc_ExitWebPayment_ReturnValue) == 0x000008, "Member 'WebPurchase_C_Dismiss::CallFunc_ExitWebPayment_ReturnValue' has a wrong offset!");
