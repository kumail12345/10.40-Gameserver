...
static_assert(offsetof(GA_Athena_Bush_AimBlocker_C_ExecuteUbergraph_GA_Athena_Bush_AimBlocker, CallFunc_GetActorInfo_ReturnValue) == 0x000048, "Member 'GA_Athena_Bush_AimBlocker_C_ExecuteUbergraph_GA_Athena_Bush_AimBlocker::CallFunc_GetActorInfo_ReturnValue' has a wrong offset!");
