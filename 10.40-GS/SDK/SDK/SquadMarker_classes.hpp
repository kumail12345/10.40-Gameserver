...
static_assert(sizeof(USquadMarker_C) == 0x000540, "Wrong size on USquadMarker_C");
static_assert(offsetof(USquadMarker_C, UberGraphFrame) == 0x000530, "Member 'USquadMarker_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(USquadMarker_C, burst) == 0x000538, "Member 'USquadMarker_C::burst' has a wrong offset!");
