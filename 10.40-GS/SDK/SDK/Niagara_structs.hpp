...
static_assert(sizeof(FNiagaraParameterStore) == 0x0000F8, "Wrong size on FNiagaraParameterStore");
...
static_assert(offsetof(FNiagaraParameterStore, UObjects) == 0x000080, "Member 'FNiagaraParameterStore::UObjects' has a wrong offset!");
...
static_assert(sizeof(FNiagaraScriptExecutionParameterStore) == 0x000118, "Wrong size on FNiagaraScriptExecutionParameterStore");
static_assert(offsetof(FNiagaraScriptExecutionParameterStore, ParameterSize) == 0x0000F8, "Member 'FNiagaraScriptExecutionParameterStore::ParameterSize' has a wrong offset!");
static_assert(offsetof(FNiagaraScriptExecutionParameterStore, PaddedParameterSize) == 0x0000FC, "Member 'FNiagaraScriptExecutionParameterStore::PaddedParameterSize' has a wrong offset!");
static_assert(offsetof(FNiagaraScriptExecutionParameterStore, PaddingInfo) == 0x000100, "Member 'FNiagaraScriptExecutionParameterStore::PaddingInfo' has a wrong offset!");
...
static_assert(sizeof(FNiagaraUserRedirectionParameterStore) == 0x000148, "Wrong size on FNiagaraUserRedirectionParameterStore");
static_assert(offsetof(FNiagaraUserRedirectionParameterStore, UserParameterRedirects) == 0x0000F8, "Member 'FNiagaraUserRedirectionParameterStore::UserParameterRedirects' has a wrong offset!");
