...
static_assert(sizeof(UGCN_Athena_Item_JollyRascal_Main_Destroy_C) == 0x0001F0, "Wrong size on UGCN_Athena_Item_JollyRascal_Main_Destroy_C");
static_assert(offsetof(UGCN_Athena_Item_JollyRascal_Main_Destroy_C, MapSound) == 0x0001A0, "Member 'UGCN_Athena_Item_JollyRascal_Main_Destroy_C::MapSound' has a wrong offset!");
