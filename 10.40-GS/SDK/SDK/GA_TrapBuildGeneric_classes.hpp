...
static_assert(sizeof(UGA_TrapBuildGeneric_C) == 0x000970, "Wrong size on UGA_TrapBuildGeneric_C");
static_assert(offsetof(UGA_TrapBuildGeneric_C, UberGraphFrame) == 0x000960, "Member 'UGA_TrapBuildGeneric_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UGA_TrapBuildGeneric_C, PlacedCue) == 0x000968, "Member 'UGA_TrapBuildGeneric_C::PlacedCue' has a wrong offset!");
