...
static_assert(alignof(UGA_OstrichKickStomp_C) == 0x000008, "Wrong alignment on UGA_OstrichKickStomp_C");
static_assert(sizeof(UGA_OstrichKickStomp_C) == 0x000A00, "Wrong size on UGA_OstrichKickStomp_C");
static_assert(offsetof(UGA_OstrichKickStomp_C, UberGraphFrame) == 0x000960, "Member 'UGA_OstrichKickStomp_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UGA_OstrichKickStomp_C, mech) == 0x000968, "Member 'UGA_OstrichKickStomp_C::mech' has a wrong offset!");
static_assert(offsetof(UGA_OstrichKickStomp_C, MoveTask) == 0x000970, "Member 'UGA_OstrichKickStomp_C::MoveTask' has a wrong offset!");
static_assert(offsetof(UGA_OstrichKickStomp_C, DashStrength) == 0x000978, "Member 'UGA_OstrichKickStomp_C::DashStrength' has a wrong offset!");
static_assert(offsetof(UGA_OstrichKickStomp_C, DashStrengthInAir) == 0x00097C, "Member 'UGA_OstrichKickStomp_C::DashStrengthInAir' has a wrong offset!");
static_assert(offsetof(UGA_OstrichKickStomp_C, Dash_Duration) == 0x000980, "Member 'UGA_OstrichKickStomp_C::Dash_Duration' has a wrong offset!");
static_assert(offsetof(UGA_OstrichKickStomp_C, DashDurationInAir) == 0x000984, "Member 'UGA_OstrichKickStomp_C::DashDurationInAir' has a wrong offset!");
static_assert(offsetof(UGA_OstrichKickStomp_C, DashDirection) == 0x000988, "Member 'UGA_OstrichKickStomp_C::DashDirection' has a wrong offset!");
static_assert(offsetof(UGA_OstrichKickStomp_C, InAirCheck) == 0x000998, "Member 'UGA_OstrichKickStomp_C::InAirCheck' has a wrong offset!");
static_assert(offsetof(UGA_OstrichKickStomp_C, P_BoostFin) == 0x0009A0, "Member 'UGA_OstrichKickStomp_C::P_BoostFin' has a wrong offset!");
static_assert(offsetof(UGA_OstrichKickStomp_C, Sound_DashActivate) == 0x0009A8, "Member 'UGA_OstrichKickStomp_C::Sound_DashActivate' has a wrong offset!");
static_assert(offsetof(UGA_OstrichKickStomp_C, LineTrace) == 0x0009B0, "Member 'UGA_OstrichKickStomp_C::LineTrace' has a wrong offset!");
static_assert(offsetof(UGA_OstrichKickStomp_C, DashCameraMode) == 0x0009B8, "Member 'UGA_OstrichKickStomp_C::DashCameraMode' has a wrong offset!");
static_assert(offsetof(UGA_OstrichKickStomp_C, P_BoostFin_Smaller) == 0x0009C0, "Member 'UGA_OstrichKickStomp_C::P_BoostFin_Smaller' has a wrong offset!");
static_assert(offsetof(UGA_OstrichKickStomp_C, NewVar_0) == 0x0009C8, "Member 'UGA_OstrichKickStomp_C::NewVar_0' has a wrong offset!");
static_assert(offsetof(UGA_OstrichKickStomp_C, AirDashMinVerticalSpeed) == 0x0009D0, "Member 'UGA_OstrichKickStomp_C::AirDashMinVerticalSpeed' has a wrong offset!");
static_assert(offsetof(UGA_OstrichKickStomp_C, P_Boost_Aftermath_LeftLeg) == 0x0009D8, "Member 'UGA_OstrichKickStomp_C::P_Boost_Aftermath_LeftLeg' has a wrong offset!");
static_assert(offsetof(UGA_OstrichKickStomp_C, P_Boost_Aftermath_RightLeg) == 0x0009E0, "Member 'UGA_OstrichKickStomp_C::P_Boost_Aftermath_RightLeg' has a wrong offset!");
static_assert(offsetof(UGA_OstrichKickStomp_C, P_Boost_Aftermath_LeftFoot) == 0x0009E8, "Member 'UGA_OstrichKickStomp_C::P_Boost_Aftermath_LeftFoot' has a wrong offset!");
static_assert(offsetof(UGA_OstrichKickStomp_C, P_Boost_Aftermath_RightFoot) == 0x0009F0, "Member 'UGA_OstrichKickStomp_C::P_Boost_Aftermath_RightFoot' has a wrong offset!");
static_assert(offsetof(UGA_OstrichKickStomp_C, P_Boost_Eye) == 0x0009F8, "Member 'UGA_OstrichKickStomp_C::P_Boost_Eye' has a wrong offset!");
