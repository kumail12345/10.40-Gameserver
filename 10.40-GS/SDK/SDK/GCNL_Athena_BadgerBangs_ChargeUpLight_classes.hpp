...
static_assert(sizeof(AGCNL_Athena_BadgerBangs_ChargeUpLight_C) == 0x000770, "Wrong size on AGCNL_Athena_BadgerBangs_ChargeUpLight_C");
static_assert(offsetof(AGCNL_Athena_BadgerBangs_ChargeUpLight_C, UberGraphFrame) == 0x000768, "Member 'AGCNL_Athena_BadgerBangs_ChargeUpLight_C::UberGraphFrame' has a wrong offset!");
