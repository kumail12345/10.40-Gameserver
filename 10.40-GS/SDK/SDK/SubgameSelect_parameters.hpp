...
static_assert(offsetof(SubgameSelect_C_UpdateHeaderAndFooter, Temp_byte_Variable_1) == 0x000004, "Member 'SubgameSelect_C_UpdateHeaderAndFooter::Temp_byte_Variable_1' has a wrong offset!");
static_assert(offsetof(SubgameSelect_C_UpdateHeaderAndFooter, Temp_bool_Variable_1) == 0x000005, "Member 'SubgameSelect_C_UpdateHeaderAndFooter::Temp_bool_Variable_1' has a wrong offset!");
...
static_assert(offsetof(SubgameSelect_C_UpdateHeaderAndFooter, Temp_byte_Variable_2) == 0x000007, "Member 'SubgameSelect_C_UpdateHeaderAndFooter::Temp_byte_Variable_2' has a wrong offset!");
static_assert(offsetof(SubgameSelect_C_UpdateHeaderAndFooter, Temp_byte_Variable_3) == 0x000008, "Member 'SubgameSelect_C_UpdateHeaderAndFooter::Temp_byte_Variable_3' has a wrong offset!");
static_assert(offsetof(SubgameSelect_C_UpdateHeaderAndFooter, K2Node_Select_Default_1) == 0x000009, "Member 'SubgameSelect_C_UpdateHeaderAndFooter::K2Node_Select_Default_1' has a wrong offset!");
...
static_assert(offsetof(SubgameSelect_C_ExecuteUbergraph_SubgameSelect, CallFunc_GetCachedWidget_ReturnValue) == 0x000008, "Member 'SubgameSelect_C_ExecuteUbergraph_SubgameSelect::CallFunc_GetCachedWidget_ReturnValue' has a wrong offset!");
static_assert(offsetof(SubgameSelect_C_ExecuteUbergraph_SubgameSelect, K2Node_Event_PreviousUIState) == 0x000010, "Member 'SubgameSelect_C_ExecuteUbergraph_SubgameSelect::K2Node_Event_PreviousUIState' has a wrong offset!");
...
static_assert(offsetof(SubgameSelect_C_ExecuteUbergraph_SubgameSelect, CallFunc_GetContext_ReturnValue_1) == 0x000020, "Member 'SubgameSelect_C_ExecuteUbergraph_SubgameSelect::CallFunc_GetContext_ReturnValue_1' has a wrong offset!");
