...
static_assert(sizeof(AAnnounce_Gen_Basic_C) == 0x000378, "Wrong size on AAnnounce_Gen_Basic_C");
static_assert(offsetof(AAnnounce_Gen_Basic_C, DefaultSceneRoot) == 0x000370, "Member 'AAnnounce_Gen_Basic_C::DefaultSceneRoot' has a wrong offset!");
