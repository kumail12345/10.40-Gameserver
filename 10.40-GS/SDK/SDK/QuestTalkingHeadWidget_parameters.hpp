...
static_assert(alignof(QuestTalkingHeadWidget_C_ExecuteUbergraph_QuestTalkingHeadWidget) == 0x000004, "Wrong alignment on QuestTalkingHeadWidget_C_ExecuteUbergraph_QuestTalkingHeadWidget");
static_assert(sizeof(QuestTalkingHeadWidget_C_ExecuteUbergraph_QuestTalkingHeadWidget) == 0x000034, "Wrong size on QuestTalkingHeadWidget_C_ExecuteUbergraph_QuestTalkingHeadWidget");
...
static_assert(offsetof(QuestTalkingHeadWidget_C_ExecuteUbergraph_QuestTalkingHeadWidget, K2Node_CreateDelegate_OutputDelegate_1) == 0x000014, "Member 'QuestTalkingHeadWidget_C_ExecuteUbergraph_QuestTalkingHeadWidget::K2Node_CreateDelegate_OutputDelegate_1' has a wrong offset!");
static_assert(offsetof(QuestTalkingHeadWidget_C_ExecuteUbergraph_QuestTalkingHeadWidget, K2Node_CreateDelegate_OutputDelegate_2) == 0x000024, "Member 'QuestTalkingHeadWidget_C_ExecuteUbergraph_QuestTalkingHeadWidget::K2Node_CreateDelegate_OutputDelegate_2' has a wrong offset!");
...
static_assert(offsetof(QuestTalkingHeadWidget_C_SetTalkingHeadName, Temp_byte_Variable_1) == 0x00001B, "Member 'QuestTalkingHeadWidget_C_SetTalkingHeadName::Temp_byte_Variable_1' has a wrong offset!");
...
static_assert(offsetof(QuestTalkingHeadWidget_C_UpdateVisibility, Temp_byte_Variable_1) == 0x000001, "Member 'QuestTalkingHeadWidget_C_UpdateVisibility::Temp_byte_Variable_1' has a wrong offset!");
static_assert(offsetof(QuestTalkingHeadWidget_C_UpdateVisibility, Temp_byte_Variable_2) == 0x000002, "Member 'QuestTalkingHeadWidget_C_UpdateVisibility::Temp_byte_Variable_2' has a wrong offset!");
static_assert(offsetof(QuestTalkingHeadWidget_C_UpdateVisibility, Temp_byte_Variable_3) == 0x000003, "Member 'QuestTalkingHeadWidget_C_UpdateVisibility::Temp_byte_Variable_3' has a wrong offset!");
