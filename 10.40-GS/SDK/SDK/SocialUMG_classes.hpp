...
static_assert(sizeof(USocialChatMessageList) == 0x000300, "Wrong size on USocialChatMessageList");
static_assert(offsetof(USocialChatMessageList, bIsFocusable) == 0x0002D0, "Member 'USocialChatMessageList::bIsFocusable' has a wrong offset!");
static_assert(offsetof(USocialChatMessageList, ActiveChannel) == 0x0002D8, "Member 'USocialChatMessageList::ActiveChannel' has a wrong offset!");
...
static_assert(sizeof(USocialGroupTreeView) == 0x0003D8, "Wrong size on USocialGroupTreeView");
static_assert(offsetof(USocialGroupTreeView, GroupEntryWidgetClass) == 0x0003B8, "Member 'USocialGroupTreeView::GroupEntryWidgetClass' has a wrong offset!");
static_assert(offsetof(USocialGroupTreeView, UserEntryWidgetClass) == 0x0003C0, "Member 'USocialGroupTreeView::UserEntryWidgetClass' has a wrong offset!");
static_assert(offsetof(USocialGroupTreeView, ActionMenuClass) == 0x0003C8, "Member 'USocialGroupTreeView::ActionMenuClass' has a wrong offset!");
static_assert(offsetof(USocialGroupTreeView, ActionMenu) == 0x0003D0, "Member 'USocialGroupTreeView::ActionMenu' has a wrong offset!");
...
static_assert(sizeof(USocialActionMenu) == 0x000248, "Wrong size on USocialActionMenu");
...
static_assert(sizeof(USocialNameTextBlock) == 0x000718, "Wrong size on USocialNameTextBlock");
static_assert(offsetof(USocialNameTextBlock, SocialUser) == 0x000698, "Member 'USocialNameTextBlock::SocialUser' has a wrong offset!");
static_assert(offsetof(USocialNameTextBlock, MinDesiredSize) == 0x0006A0, "Member 'USocialNameTextBlock::MinDesiredSize' has a wrong offset!");
static_assert(offsetof(USocialNameTextBlock, MaxDesiredSize) == 0x0006A4, "Member 'USocialNameTextBlock::MaxDesiredSize' has a wrong offset!");
static_assert(offsetof(USocialNameTextBlock, bShowNickName) == 0x0006A8, "Member 'USocialNameTextBlock::bShowNickName' has a wrong offset!");
static_assert(offsetof(USocialNameTextBlock, PlatformIconDisplayRule) == 0x0006A9, "Member 'USocialNameTextBlock::PlatformIconDisplayRule' has a wrong offset!");
static_assert(offsetof(USocialNameTextBlock, bNickNameInNextLine) == 0x0006AA, "Member 'USocialNameTextBlock::bNickNameInNextLine' has a wrong offset!");
static_assert(offsetof(USocialNameTextBlock, bOverwriteNickNameColorAndSize) == 0x0006AB, "Member 'USocialNameTextBlock::bOverwriteNickNameColorAndSize' has a wrong offset!");
static_assert(offsetof(USocialNameTextBlock, NickNameColor) == 0x0006AC, "Member 'USocialNameTextBlock::NickNameColor' has a wrong offset!");
static_assert(offsetof(USocialNameTextBlock, NickNameFontSize) == 0x0006B0, "Member 'USocialNameTextBlock::NickNameFontSize' has a wrong offset!");
static_assert(offsetof(USocialNameTextBlock, bFlippingNickName) == 0x0006B4, "Member 'USocialNameTextBlock::bFlippingNickName' has a wrong offset!");
static_assert(offsetof(USocialNameTextBlock, DisplayTime) == 0x0006B8, "Member 'USocialNameTextBlock::DisplayTime' has a wrong offset!");
static_assert(offsetof(USocialNameTextBlock, NickNameDisplayTime) == 0x0006BC, "Member 'USocialNameTextBlock::NickNameDisplayTime' has a wrong offset!");
static_assert(offsetof(USocialNameTextBlock, FadeInDuration) == 0x0006C0, "Member 'USocialNameTextBlock::FadeInDuration' has a wrong offset!");
static_assert(offsetof(USocialNameTextBlock, FadeOutDuration) == 0x0006C4, "Member 'USocialNameTextBlock::FadeOutDuration' has a wrong offset!");
...
static_assert(sizeof(USocialListEntryBase) == 0x000B58, "Wrong size on USocialListEntryBase");
...
static_assert(sizeof(USocialListInteractableEntryBase) == 0x000B68, "Wrong size on USocialListInteractableEntryBase");
static_assert(offsetof(USocialListInteractableEntryBase, ActionMenuClass) == 0x000B58, "Member 'USocialListInteractableEntryBase::ActionMenuClass' has a wrong offset!");
static_assert(offsetof(USocialListInteractableEntryBase, MenuAnchor_Actions) == 0x000B60, "Member 'USocialListInteractableEntryBase::MenuAnchor_Actions' has a wrong offset!");
...
static_assert(sizeof(USocialListUserEntryBase) == 0x000B88, "Wrong size on USocialListUserEntryBase");
static_assert(offsetof(USocialListUserEntryBase, Text_SocialName) == 0x000B70, "Member 'USocialListUserEntryBase::Text_SocialName' has a wrong offset!");
static_assert(offsetof(USocialListUserEntryBase, Text_RichPresence) == 0x000B78, "Member 'USocialListUserEntryBase::Text_RichPresence' has a wrong offset!");
static_assert(offsetof(USocialListUserEntryBase, Image_EncourageEpicFriend) == 0x000B80, "Member 'USocialListUserEntryBase::Image_EncourageEpicFriend' has a wrong offset!");
...
static_assert(alignof(USocialListEntry_SocialUser) == 0x000008, "Wrong alignment on USocialListEntry_SocialUser");
static_assert(sizeof(USocialListEntry_SocialUser) == 0x000B88, "Wrong size on USocialListEntry_SocialUser");
...
static_assert(sizeof(USocialUserListHeaderEntry) == 0x000B68, "Wrong size on USocialUserListHeaderEntry");
static_assert(offsetof(USocialUserListHeaderEntry, Text_ListName) == 0x000B58, "Member 'USocialUserListHeaderEntry::Text_ListName' has a wrong offset!");
static_assert(offsetof(USocialUserListHeaderEntry, Text_NumEntries) == 0x000B60, "Member 'USocialUserListHeaderEntry::Text_NumEntries' has a wrong offset!");
...
{
public:
	uint8                                         Pad_210[0xE0];                                     // 0x0210(0x00E0)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(USocialUserListView) == 0x0002F8, "Wrong size on USocialUserListView");
static_assert(offsetof(USocialUserListView, EntrySpacing) == 0x0002F0, "Member 'USocialUserListView::EntrySpacing' has a wrong offset!");
...
static_assert(sizeof(USocialUserTreeView) == 0x0003F8, "Wrong size on USocialUserTreeView");
static_assert(offsetof(USocialUserTreeView, UserEntryWidgetClass) == 0x000368, "Member 'USocialUserTreeView::UserEntryWidgetClass' has a wrong offset!");
static_assert(offsetof(USocialUserTreeView, InviteEntryWidgetClass) == 0x000370, "Member 'USocialUserTreeView::InviteEntryWidgetClass' has a wrong offset!");
static_assert(offsetof(USocialUserTreeView, ActiveActionMenu) == 0x0003A0, "Member 'USocialUserTreeView::ActiveActionMenu' has a wrong offset!");
static_assert(offsetof(USocialUserTreeView, CachedActionMenuPool) == 0x0003A8, "Member 'USocialUserTreeView::CachedActionMenuPool' has a wrong offset!");
