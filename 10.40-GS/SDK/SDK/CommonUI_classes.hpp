...
static_assert(sizeof(UAnalogSlider) == 0x0004F8, "Wrong size on UAnalogSlider");
static_assert(offsetof(UAnalogSlider, OnAnalogCapture) == 0x0004E8, "Member 'UAnalogSlider::OnAnalogCapture' has a wrong offset!");
...
static_assert(offsetof(UCommonActionWidget, InputActions) == 0x000228, "Member 'UCommonActionWidget::InputActions' has a wrong offset!");
...
static_assert(offsetof(UCommonTextBlock, MobileFontSizeMultiplier) == 0x0002AC, "Member 'UCommonTextBlock::MobileFontSizeMultiplier' has a wrong offset!");
...
static_assert(sizeof(UCommonListView) == 0x000360, "Wrong size on UCommonListView");
...
public:
	...
	TMulticastInlineDelegate<void(class UCommonNumericTextBlock* NumericTextBlock, bool HadCompleted)> OnInterpolationEndedEvent;                         // 0x02D0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UCommonRichTextBlock, MobileFontSizeMultiplier) == 0x000670, "Member 'UCommonRichTextBlock::MobileFontSizeMultiplier' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_B80[0x18];                                     // 0x0B80(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UCommonRotator) == 0x000B98, "Wrong size on UCommonRotator");
static_assert(offsetof(UCommonRotator, OnRotated) == 0x000B50, "Member 'UCommonRotator::OnRotated' has a wrong offset!");
static_assert(offsetof(UCommonRotator, MyText) == 0x000B78, "Member 'UCommonRotator::MyText' has a wrong offset!");
...
static_assert(sizeof(UCommonTileView) == 0x000380, "Wrong size on UCommonTileView");
...
static_assert(sizeof(UCommonTreeView) == 0x0003B8, "Wrong size on UCommonTreeView");
...
static_assert(sizeof(UCommonVideoPlayer) == 0x000210, "Wrong size on UCommonVideoPlayer");
...
static_assert(offsetof(UCommonVideoPlayer, VideoBrush) == 0x000128, "Member 'UCommonVideoPlayer::VideoBrush' has a wrong offset!");
