...
static_assert(sizeof(UAthenaTemperature_C) == 0x000248, "Wrong size on UAthenaTemperature_C");
static_assert(offsetof(UAthenaTemperature_C, UberGraphFrame) == 0x000240, "Member 'UAthenaTemperature_C::UberGraphFrame' has a wrong offset!");
