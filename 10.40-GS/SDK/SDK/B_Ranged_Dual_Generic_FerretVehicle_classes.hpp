...
static_assert(sizeof(AB_Ranged_Dual_Generic_FerretVehicle_C) == 0x000EE8, "Wrong size on AB_Ranged_Dual_Generic_FerretVehicle_C");
static_assert(offsetof(AB_Ranged_Dual_Generic_FerretVehicle_C, UberGraphFrame) == 0x000D48, "Member 'AB_Ranged_Dual_Generic_FerretVehicle_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AB_Ranged_Dual_Generic_FerretVehicle_C, LeftReload_Empty_) == 0x000D50, "Member 'AB_Ranged_Dual_Generic_FerretVehicle_C::LeftReload_Empty_' has a wrong offset!");
static_assert(offsetof(AB_Ranged_Dual_Generic_FerretVehicle_C, LeftShells_Empty_) == 0x000D58, "Member 'AB_Ranged_Dual_Generic_FerretVehicle_C::LeftShells_Empty_' has a wrong offset!");
static_assert(offsetof(AB_Ranged_Dual_Generic_FerretVehicle_C, LeftMuzzle_Empty_) == 0x000D60, "Member 'AB_Ranged_Dual_Generic_FerretVehicle_C::LeftMuzzle_Empty_' has a wrong offset!");
static_assert(offsetof(AB_Ranged_Dual_Generic_FerretVehicle_C, Reload_Empty_) == 0x000D68, "Member 'AB_Ranged_Dual_Generic_FerretVehicle_C::Reload_Empty_' has a wrong offset!");
static_assert(offsetof(AB_Ranged_Dual_Generic_FerretVehicle_C, Shells_empty_) == 0x000D70, "Member 'AB_Ranged_Dual_Generic_FerretVehicle_C::Shells_empty_' has a wrong offset!");
static_assert(offsetof(AB_Ranged_Dual_Generic_FerretVehicle_C, ScopeMesh1P) == 0x000D78, "Member 'AB_Ranged_Dual_Generic_FerretVehicle_C::ScopeMesh1P' has a wrong offset!");
static_assert(offsetof(AB_Ranged_Dual_Generic_FerretVehicle_C, Muzzle_Empty_) == 0x000D80, "Member 'AB_Ranged_Dual_Generic_FerretVehicle_C::Muzzle_Empty_' has a wrong offset!");
static_assert(offsetof(AB_Ranged_Dual_Generic_FerretVehicle_C, MuzzleParticleSystem) == 0x000D88, "Member 'AB_Ranged_Dual_Generic_FerretVehicle_C::MuzzleParticleSystem' has a wrong offset!");
static_assert(offsetof(AB_Ranged_Dual_Generic_FerretVehicle_C, WeaponDurabilityDestroyEffect) == 0x000D90, "Member 'AB_Ranged_Dual_Generic_FerretVehicle_C::WeaponDurabilityDestroyEffect' has a wrong offset!");
static_assert(offsetof(AB_Ranged_Dual_Generic_FerretVehicle_C, WeaponDurabilityDestroyEffectIcon) == 0x000D98, "Member 'AB_Ranged_Dual_Generic_FerretVehicle_C::WeaponDurabilityDestroyEffectIcon' has a wrong offset!");
static_assert(offsetof(AB_Ranged_Dual_Generic_FerretVehicle_C, UseDestroyEffect) == 0x000DA0, "Member 'AB_Ranged_Dual_Generic_FerretVehicle_C::UseDestroyEffect' has a wrong offset!");
static_assert(offsetof(AB_Ranged_Dual_Generic_FerretVehicle_C, Use_Reload_Particles) == 0x000DA1, "Member 'AB_Ranged_Dual_Generic_FerretVehicle_C::Use_Reload_Particles' has a wrong offset!");
static_assert(offsetof(AB_Ranged_Dual_Generic_FerretVehicle_C, Reload_ParticleSystem) == 0x000DA8, "Member 'AB_Ranged_Dual_Generic_FerretVehicle_C::Reload_ParticleSystem' has a wrong offset!");
static_assert(offsetof(AB_Ranged_Dual_Generic_FerretVehicle_C, LastPlayFXTime) == 0x000DB0, "Member 'AB_Ranged_Dual_Generic_FerretVehicle_C::LastPlayFXTime' has a wrong offset!");
static_assert(offsetof(AB_Ranged_Dual_Generic_FerretVehicle_C, MinPlayFXTime) == 0x000DB4, "Member 'AB_Ranged_Dual_Generic_FerretVehicle_C::MinPlayFXTime' has a wrong offset!");
static_assert(offsetof(AB_Ranged_Dual_Generic_FerretVehicle_C, UseShellsOnFire_) == 0x000DB8, "Member 'AB_Ranged_Dual_Generic_FerretVehicle_C::UseShellsOnFire_' has a wrong offset!");
static_assert(offsetof(AB_Ranged_Dual_Generic_FerretVehicle_C, UseShellsOnReload_) == 0x000DB9, "Member 'AB_Ranged_Dual_Generic_FerretVehicle_C::UseShellsOnReload_' has a wrong offset!");
static_assert(offsetof(AB_Ranged_Dual_Generic_FerretVehicle_C, UseShellsOnPump_) == 0x000DBA, "Member 'AB_Ranged_Dual_Generic_FerretVehicle_C::UseShellsOnPump_' has a wrong offset!");
static_assert(offsetof(AB_Ranged_Dual_Generic_FerretVehicle_C, ShellsParticleSystemTemplate) == 0x000DC0, "Member 'AB_Ranged_Dual_Generic_FerretVehicle_C::ShellsParticleSystemTemplate' has a wrong offset!");
static_assert(offsetof(AB_Ranged_Dual_Generic_FerretVehicle_C, ReloadSocketName) == 0x000DC8, "Member 'AB_Ranged_Dual_Generic_FerretVehicle_C::ReloadSocketName' has a wrong offset!");
static_assert(offsetof(AB_Ranged_Dual_Generic_FerretVehicle_C, Array_Of_Active_Enemy_AI) == 0x000DD0, "Member 'AB_Ranged_Dual_Generic_FerretVehicle_C::Array_Of_Active_Enemy_AI' has a wrong offset!");
static_assert(offsetof(AB_Ranged_Dual_Generic_FerretVehicle_C, Scope___Render_Enemies_To_Custom_Depth_Buffer) == 0x000DE0, "Member 'AB_Ranged_Dual_Generic_FerretVehicle_C::Scope___Render_Enemies_To_Custom_Depth_Buffer' has a wrong offset!");
static_assert(offsetof(AB_Ranged_Dual_Generic_FerretVehicle_C, Shells_Socket_Name) == 0x000DE4, "Member 'AB_Ranged_Dual_Generic_FerretVehicle_C::Shells_Socket_Name' has a wrong offset!");
static_assert(offsetof(AB_Ranged_Dual_Generic_FerretVehicle_C, ShellTypeSelect) == 0x000DEC, "Member 'AB_Ranged_Dual_Generic_FerretVehicle_C::ShellTypeSelect' has a wrong offset!");
static_assert(offsetof(AB_Ranged_Dual_Generic_FerretVehicle_C, Shells_Spawn_Rate_Scale) == 0x000DF0, "Member 'AB_Ranged_Dual_Generic_FerretVehicle_C::Shells_Spawn_Rate_Scale' has a wrong offset!");
static_assert(offsetof(AB_Ranged_Dual_Generic_FerretVehicle_C, ShellsRotationRate) == 0x000DF4, "Member 'AB_Ranged_Dual_Generic_FerretVehicle_C::ShellsRotationRate' has a wrong offset!");
static_assert(offsetof(AB_Ranged_Dual_Generic_FerretVehicle_C, Shells_Velocity) == 0x000E00, "Member 'AB_Ranged_Dual_Generic_FerretVehicle_C::Shells_Velocity' has a wrong offset!");
static_assert(offsetof(AB_Ranged_Dual_Generic_FerretVehicle_C, Shells_Gravity) == 0x000E0C, "Member 'AB_Ranged_Dual_Generic_FerretVehicle_C::Shells_Gravity' has a wrong offset!");
static_assert(offsetof(AB_Ranged_Dual_Generic_FerretVehicle_C, Shells_Lifetime) == 0x000E18, "Member 'AB_Ranged_Dual_Generic_FerretVehicle_C::Shells_Lifetime' has a wrong offset!");
static_assert(offsetof(AB_Ranged_Dual_Generic_FerretVehicle_C, Shells_Size) == 0x000E1C, "Member 'AB_Ranged_Dual_Generic_FerretVehicle_C::Shells_Size' has a wrong offset!");
static_assert(offsetof(AB_Ranged_Dual_Generic_FerretVehicle_C, Shells_Time_Dilation) == 0x000E28, "Member 'AB_Ranged_Dual_Generic_FerretVehicle_C::Shells_Time_Dilation' has a wrong offset!");
static_assert(offsetof(AB_Ranged_Dual_Generic_FerretVehicle_C, Target_Scope_Vignette_Blur_Screen_Percentage) == 0x000E2C, "Member 'AB_Ranged_Dual_Generic_FerretVehicle_C::Target_Scope_Vignette_Blur_Screen_Percentage' has a wrong offset!");
static_assert(offsetof(AB_Ranged_Dual_Generic_FerretVehicle_C, Scope_Camera_Offset_Amount) == 0x000E30, "Member 'AB_Ranged_Dual_Generic_FerretVehicle_C::Scope_Camera_Offset_Amount' has a wrong offset!");
static_assert(offsetof(AB_Ranged_Dual_Generic_FerretVehicle_C, SmallShells) == 0x000E34, "Member 'AB_Ranged_Dual_Generic_FerretVehicle_C::SmallShells' has a wrong offset!");
static_assert(offsetof(AB_Ranged_Dual_Generic_FerretVehicle_C, MediumShells) == 0x000E35, "Member 'AB_Ranged_Dual_Generic_FerretVehicle_C::MediumShells' has a wrong offset!");
static_assert(offsetof(AB_Ranged_Dual_Generic_FerretVehicle_C, LargeShells) == 0x000E36, "Member 'AB_Ranged_Dual_Generic_FerretVehicle_C::LargeShells' has a wrong offset!");
static_assert(offsetof(AB_Ranged_Dual_Generic_FerretVehicle_C, ShotgunShells) == 0x000E37, "Member 'AB_Ranged_Dual_Generic_FerretVehicle_C::ShotgunShells' has a wrong offset!");
static_assert(offsetof(AB_Ranged_Dual_Generic_FerretVehicle_C, EnergyShells) == 0x000E38, "Member 'AB_Ranged_Dual_Generic_FerretVehicle_C::EnergyShells' has a wrong offset!");
static_assert(offsetof(AB_Ranged_Dual_Generic_FerretVehicle_C, Inherit_Parent_Velocity) == 0x000E3C, "Member 'AB_Ranged_Dual_Generic_FerretVehicle_C::Inherit_Parent_Velocity' has a wrong offset!");
static_assert(offsetof(AB_Ranged_Dual_Generic_FerretVehicle_C, Cylindrical_Radius) == 0x000E40, "Member 'AB_Ranged_Dual_Generic_FerretVehicle_C::Cylindrical_Radius' has a wrong offset!");
static_assert(offsetof(AB_Ranged_Dual_Generic_FerretVehicle_C, Cylindrical_Height) == 0x000E44, "Member 'AB_Ranged_Dual_Generic_FerretVehicle_C::Cylindrical_Height' has a wrong offset!");
static_assert(offsetof(AB_Ranged_Dual_Generic_FerretVehicle_C, DebugShellsSocket_) == 0x000E48, "Member 'AB_Ranged_Dual_Generic_FerretVehicle_C::DebugShellsSocket_' has a wrong offset!");
static_assert(offsetof(AB_Ranged_Dual_Generic_FerretVehicle_C, Use_2_Post_Processes_For_the_Scope) == 0x000E49, "Member 'AB_Ranged_Dual_Generic_FerretVehicle_C::Use_2_Post_Processes_For_the_Scope' has a wrong offset!");
static_assert(offsetof(AB_Ranged_Dual_Generic_FerretVehicle_C, Sound_ScopeZoomIn) == 0x000E50, "Member 'AB_Ranged_Dual_Generic_FerretVehicle_C::Sound_ScopeZoomIn' has a wrong offset!");
static_assert(offsetof(AB_Ranged_Dual_Generic_FerretVehicle_C, Sound_ScopeZoomOut) == 0x000E58, "Member 'AB_Ranged_Dual_Generic_FerretVehicle_C::Sound_ScopeZoomOut' has a wrong offset!");
static_assert(offsetof(AB_Ranged_Dual_Generic_FerretVehicle_C, Alteration_Ambient_PS) == 0x000E60, "Member 'AB_Ranged_Dual_Generic_FerretVehicle_C::Alteration_Ambient_PS' has a wrong offset!");
static_assert(offsetof(AB_Ranged_Dual_Generic_FerretVehicle_C, ReticleHUDElementTags) == 0x000E68, "Member 'AB_Ranged_Dual_Generic_FerretVehicle_C::ReticleHUDElementTags' has a wrong offset!");
static_assert(offsetof(AB_Ranged_Dual_Generic_FerretVehicle_C, Is_Wind_Enabled) == 0x000E88, "Member 'AB_Ranged_Dual_Generic_FerretVehicle_C::Is_Wind_Enabled' has a wrong offset!");
static_assert(offsetof(AB_Ranged_Dual_Generic_FerretVehicle_C, MuzzleWindParticleSystem) == 0x000E90, "Member 'AB_Ranged_Dual_Generic_FerretVehicle_C::MuzzleWindParticleSystem' has a wrong offset!");
static_assert(offsetof(AB_Ranged_Dual_Generic_FerretVehicle_C, MuzzleParticleSystem1P) == 0x000E98, "Member 'AB_Ranged_Dual_Generic_FerretVehicle_C::MuzzleParticleSystem1P' has a wrong offset!");
static_assert(offsetof(AB_Ranged_Dual_Generic_FerretVehicle_C, DownScopePostProcessSpawned) == 0x000EA0, "Member 'AB_Ranged_Dual_Generic_FerretVehicle_C::DownScopePostProcessSpawned' has a wrong offset!");
static_assert(offsetof(AB_Ranged_Dual_Generic_FerretVehicle_C, DownScopePostProcessSpawned2) == 0x000EA8, "Member 'AB_Ranged_Dual_Generic_FerretVehicle_C::DownScopePostProcessSpawned2' has a wrong offset!");
static_assert(offsetof(AB_Ranged_Dual_Generic_FerretVehicle_C, MuzzleWindParticleSpawned) == 0x000EB0, "Member 'AB_Ranged_Dual_Generic_FerretVehicle_C::MuzzleWindParticleSpawned' has a wrong offset!");
static_assert(offsetof(AB_Ranged_Dual_Generic_FerretVehicle_C, LastHandFired) == 0x000EB8, "Member 'AB_Ranged_Dual_Generic_FerretVehicle_C::LastHandFired' has a wrong offset!");
static_assert(offsetof(AB_Ranged_Dual_Generic_FerretVehicle_C, PlayerPawn) == 0x000EC0, "Member 'AB_Ranged_Dual_Generic_FerretVehicle_C::PlayerPawn' has a wrong offset!");
static_assert(offsetof(AB_Ranged_Dual_Generic_FerretVehicle_C, StartHeatingTimer) == 0x000EC8, "Member 'AB_Ranged_Dual_Generic_FerretVehicle_C::StartHeatingTimer' has a wrong offset!");
static_assert(offsetof(AB_Ranged_Dual_Generic_FerretVehicle_C, StartCoolingTimer) == 0x000ED0, "Member 'AB_Ranged_Dual_Generic_FerretVehicle_C::StartCoolingTimer' has a wrong offset!");
static_assert(offsetof(AB_Ranged_Dual_Generic_FerretVehicle_C, FireState) == 0x000ED8, "Member 'AB_Ranged_Dual_Generic_FerretVehicle_C::FireState' has a wrong offset!");
static_assert(offsetof(AB_Ranged_Dual_Generic_FerretVehicle_C, Sound_OnFailToFireWhenOverheated) == 0x000EE0, "Member 'AB_Ranged_Dual_Generic_FerretVehicle_C::Sound_OnFailToFireWhenOverheated' has a wrong offset!");
