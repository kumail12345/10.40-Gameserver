...
static_assert(sizeof(UHelpEntryBodyWidget_C) == 0x000268, "Wrong size on UHelpEntryBodyWidget_C");
static_assert(offsetof(UHelpEntryBodyWidget_C, BottomContentBorder) == 0x000230, "Member 'UHelpEntryBodyWidget_C::BottomContentBorder' has a wrong offset!");
static_assert(offsetof(UHelpEntryBodyWidget_C, BottomImage) == 0x000238, "Member 'UHelpEntryBodyWidget_C::BottomImage' has a wrong offset!");
static_assert(offsetof(UHelpEntryBodyWidget_C, EntryBody) == 0x000240, "Member 'UHelpEntryBodyWidget_C::EntryBody' has a wrong offset!");
static_assert(offsetof(UHelpEntryBodyWidget_C, RootVerticalBox) == 0x000248, "Member 'UHelpEntryBodyWidget_C::RootVerticalBox' has a wrong offset!");
static_assert(offsetof(UHelpEntryBodyWidget_C, TopContentBorder) == 0x000250, "Member 'UHelpEntryBodyWidget_C::TopContentBorder' has a wrong offset!");
static_assert(offsetof(UHelpEntryBodyWidget_C, TopImage) == 0x000258, "Member 'UHelpEntryBodyWidget_C::TopImage' has a wrong offset!");
static_assert(offsetof(UHelpEntryBodyWidget_C, ActiveHelpItem) == 0x000260, "Member 'UHelpEntryBodyWidget_C::ActiveHelpItem' has a wrong offset!");
