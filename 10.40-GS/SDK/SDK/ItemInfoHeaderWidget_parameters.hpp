...
static_assert(sizeof(ItemInfoHeaderWidget_C_OverrideHeaderAndDiscription) == 0x0000D0, "Wrong size on ItemInfoHeaderWidget_C_OverrideHeaderAndDiscription");
...
static_assert(offsetof(ItemInfoHeaderWidget_C_OverrideHeaderAndDiscription, CallFunc_BPGetRarityColorPalette_ReturnValue) == 0x00006C, "Member 'ItemInfoHeaderWidget_C_OverrideHeaderAndDiscription::CallFunc_BPGetRarityColorPalette_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemInfoHeaderWidget_C_OverrideHeaderAndDiscription, Temp_byte_Variable_1) == 0x0000BC, "Member 'ItemInfoHeaderWidget_C_OverrideHeaderAndDiscription::Temp_byte_Variable_1' has a wrong offset!");
static_assert(offsetof(ItemInfoHeaderWidget_C_OverrideHeaderAndDiscription, K2Node_Select_Default) == 0x0000C0, "Member 'ItemInfoHeaderWidget_C_OverrideHeaderAndDiscription::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(ItemInfoHeaderWidget_C_OverrideHeaderAndDiscription, Temp_bool_Variable_1) == 0x0000C8, "Member 'ItemInfoHeaderWidget_C_OverrideHeaderAndDiscription::Temp_bool_Variable_1' has a wrong offset!");
static_assert(offsetof(ItemInfoHeaderWidget_C_OverrideHeaderAndDiscription, K2Node_Select_Default_1) == 0x0000C9, "Member 'ItemInfoHeaderWidget_C_OverrideHeaderAndDiscription::K2Node_Select_Default_1' has a wrong offset!");
...
static_assert(sizeof(ItemInfoHeaderWidget_C_Update) == 0x000098, "Wrong size on ItemInfoHeaderWidget_C_Update");
...
static_assert(offsetof(ItemInfoHeaderWidget_C_Update, CallFunc_GetRarityOrSeriesColors_ReturnValue) == 0x000040, "Member 'ItemInfoHeaderWidget_C_Update::CallFunc_GetRarityOrSeriesColors_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemInfoHeaderWidget_C_Update, CallFunc_TextIsEmpty_ReturnValue) == 0x000090, "Member 'ItemInfoHeaderWidget_C_Update::CallFunc_TextIsEmpty_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemInfoHeaderWidget_C_Update, Temp_byte_Variable_1) == 0x000091, "Member 'ItemInfoHeaderWidget_C_Update::Temp_byte_Variable_1' has a wrong offset!");
static_assert(offsetof(ItemInfoHeaderWidget_C_Update, Temp_bool_Variable) == 0x000092, "Member 'ItemInfoHeaderWidget_C_Update::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(ItemInfoHeaderWidget_C_Update, K2Node_Select_Default) == 0x000093, "Member 'ItemInfoHeaderWidget_C_Update::K2Node_Select_Default' has a wrong offset!");
