...
static_assert(sizeof(UGA_AthenaInVehicle_C) == 0x000988, "Wrong size on UGA_AthenaInVehicle_C");
static_assert(offsetof(UGA_AthenaInVehicle_C, UberGraphFrame) == 0x000960, "Member 'UGA_AthenaInVehicle_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UGA_AthenaInVehicle_C, ExitTag) == 0x000968, "Member 'UGA_AthenaInVehicle_C::ExitTag' has a wrong offset!");
