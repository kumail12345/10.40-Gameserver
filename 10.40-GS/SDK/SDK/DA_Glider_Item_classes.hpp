...
static_assert(sizeof(ADA_Glider_Item_C) == 0x000A38, "Wrong size on ADA_Glider_Item_C");
static_assert(offsetof(ADA_Glider_Item_C, UberGraphFrame) == 0x0009D0, "Member 'ADA_Glider_Item_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ADA_Glider_Item_C, ErrorReason) == 0x0009D8, "Member 'ADA_Glider_Item_C::ErrorReason' has a wrong offset!");
static_assert(offsetof(ADA_Glider_Item_C, ErrorReasonGamepad) == 0x0009F8, "Member 'ADA_Glider_Item_C::ErrorReasonGamepad' has a wrong offset!");
static_assert(offsetof(ADA_Glider_Item_C, ErrorCannotUse) == 0x000A18, "Member 'ADA_Glider_Item_C::ErrorCannotUse' has a wrong offset!");
