...
public:
	...
	uint8                                         Pad_174[0x294];                                    // 0x0174(0x0294)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(USubtitleDisplay) == 0x000408, "Wrong size on USubtitleDisplay");
static_assert(offsetof(USubtitleDisplay, BP_SubtitleChangedEvent) == 0x000100, "Member 'USubtitleDisplay::BP_SubtitleChangedEvent' has a wrong offset!");
static_assert(offsetof(USubtitleDisplay, FontInfo) == 0x000110, "Member 'USubtitleDisplay::FontInfo' has a wrong offset!");
static_assert(offsetof(USubtitleDisplay, ColorAndOpacity) == 0x000160, "Member 'USubtitleDisplay::ColorAndOpacity' has a wrong offset!");
static_assert(offsetof(USubtitleDisplay, WrapTextAt) == 0x000170, "Member 'USubtitleDisplay::WrapTextAt' has a wrong offset!");
