...
static_assert(sizeof(UAthenaStatsRow_C) == 0x000270, "Wrong size on UAthenaStatsRow_C");
...
static_assert(offsetof(UAthenaStatsRow_C, StatName) == 0x000248, "Member 'UAthenaStatsRow_C::StatName' has a wrong offset!");
static_assert(offsetof(UAthenaStatsRow_C, BaseGameplayTag) == 0x000260, "Member 'UAthenaStatsRow_C::BaseGameplayTag' has a wrong offset!");
