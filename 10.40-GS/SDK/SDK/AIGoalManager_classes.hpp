...
static_assert(sizeof(AAIGoalManager_C) == 0x000338, "Wrong size on AAIGoalManager_C");
static_assert(offsetof(AAIGoalManager_C, DefaultSceneRoot) == 0x000330, "Member 'AAIGoalManager_C::DefaultSceneRoot' has a wrong offset!");
