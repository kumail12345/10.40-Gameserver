...
static_assert(offsetof(BannerSelectionWidget_C_ExecuteUbergraph_BannerSelectionWidget, CallFunc_GetContext_ReturnValue) == 0x0000A8, "Member 'BannerSelectionWidget_C_ExecuteUbergraph_BannerSelectionWidget::CallFunc_GetContext_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(BannerSelectionWidget_C_ExecuteUbergraph_BannerSelectionWidget, CallFunc_GetCurrentInputType_ReturnValue) == 0x0000B8, "Member 'BannerSelectionWidget_C_ExecuteUbergraph_BannerSelectionWidget::CallFunc_GetCurrentInputType_ReturnValue' has a wrong offset!");
static_assert(offsetof(BannerSelectionWidget_C_ExecuteUbergraph_BannerSelectionWidget, K2Node_DynamicCast_AsFort_Player_Controller_4) == 0x0000C0, "Member 'BannerSelectionWidget_C_ExecuteUbergraph_BannerSelectionWidget::K2Node_DynamicCast_AsFort_Player_Controller_4' has a wrong offset!");
static_assert(offsetof(BannerSelectionWidget_C_ExecuteUbergraph_BannerSelectionWidget, K2Node_DynamicCast_bSuccess_4) == 0x0000C8, "Member 'BannerSelectionWidget_C_ExecuteUbergraph_BannerSelectionWidget::K2Node_DynamicCast_bSuccess_4' has a wrong offset!");
static_assert(offsetof(BannerSelectionWidget_C_ExecuteUbergraph_BannerSelectionWidget, CallFunc_GetContext_ReturnValue_1) == 0x0000D0, "Member 'BannerSelectionWidget_C_ExecuteUbergraph_BannerSelectionWidget::CallFunc_GetContext_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BannerSelectionWidget_C_ExecuteUbergraph_BannerSelectionWidget, CallFunc_GetText_ReturnValue) == 0x0000D8, "Member 'BannerSelectionWidget_C_ExecuteUbergraph_BannerSelectionWidget::CallFunc_GetText_ReturnValue' has a wrong offset!");
static_assert(offsetof(BannerSelectionWidget_C_ExecuteUbergraph_BannerSelectionWidget, CallFunc_IsPlayerNameValid_OutIsValid) == 0x0000F0, "Member 'BannerSelectionWidget_C_ExecuteUbergraph_BannerSelectionWidget::CallFunc_IsPlayerNameValid_OutIsValid' has a wrong offset!");
static_assert(offsetof(BannerSelectionWidget_C_ExecuteUbergraph_BannerSelectionWidget, CallFunc_IsPlayerNameValid_OutErrorText) == 0x0000F8, "Member 'BannerSelectionWidget_C_ExecuteUbergraph_BannerSelectionWidget::CallFunc_IsPlayerNameValid_OutErrorText' has a wrong offset!");
