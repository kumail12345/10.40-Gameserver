...
static_assert(offsetof(UToastDisplayArea_C, UberGraphFrame) == 0x000268, "Member 'UToastDisplayArea_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UToastDisplayArea_C, SafeZone_0) == 0x000270, "Member 'UToastDisplayArea_C::SafeZone_0' has a wrong offset!");
