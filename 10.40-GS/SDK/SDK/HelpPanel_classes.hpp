...
static_assert(sizeof(UHelpPanel_C) == 0x0003C0, "Wrong size on UHelpPanel_C");
static_assert(offsetof(UHelpPanel_C, UberGraphFrame) == 0x000340, "Member 'UHelpPanel_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UHelpPanel_C, CloseButton) == 0x000348, "Member 'UHelpPanel_C::CloseButton' has a wrong offset!");
static_assert(offsetof(UHelpPanel_C, CloseIcon) == 0x000350, "Member 'UHelpPanel_C::CloseIcon' has a wrong offset!");
...
static_assert(offsetof(UHelpPanel_C, MobileCloseButton) == 0x000380, "Member 'UHelpPanel_C::MobileCloseButton' has a wrong offset!");
static_assert(offsetof(UHelpPanel_C, MobileCloseOverlay) == 0x000388, "Member 'UHelpPanel_C::MobileCloseOverlay' has a wrong offset!");
static_assert(offsetof(UHelpPanel_C, TextHeader) == 0x000390, "Member 'UHelpPanel_C::TextHeader' has a wrong offset!");
static_assert(offsetof(UHelpPanel_C, TopLevelHelpItems) == 0x000398, "Member 'UHelpPanel_C::TopLevelHelpItems' has a wrong offset!");
static_assert(offsetof(UHelpPanel_C, Header_Display_Text) == 0x0003A8, "Member 'UHelpPanel_C::Header_Display_Text' has a wrong offset!");
