...
static_assert(alignof(UGCN_Athena_Ostrich_Enter_Gunner_C) == 0x000008, "Wrong alignment on UGCN_Athena_Ostrich_Enter_Gunner_C");
static_assert(sizeof(UGCN_Athena_Ostrich_Enter_Gunner_C) == 0x0001A0, "Wrong size on UGCN_Athena_Ostrich_Enter_Gunner_C");
