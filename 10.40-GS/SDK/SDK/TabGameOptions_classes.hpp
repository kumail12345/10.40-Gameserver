...
static_assert(sizeof(UTabGameOptions_C) == 0x0002B0, "Wrong size on UTabGameOptions_C");
static_assert(offsetof(UTabGameOptions_C, UberGraphFrame) == 0x000290, "Member 'UTabGameOptions_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UTabGameOptions_C, CommonWidgetSwitcher_0) == 0x000298, "Member 'UTabGameOptions_C::CommonWidgetSwitcher_0' has a wrong offset!");
static_assert(offsetof(UTabGameOptions_C, GameTabs) == 0x0002A0, "Member 'UTabGameOptions_C::GameTabs' has a wrong offset!");
static_assert(offsetof(UTabGameOptions_C, TooltipDisplay) == 0x0002A8, "Member 'UTabGameOptions_C::TooltipDisplay' has a wrong offset!");
