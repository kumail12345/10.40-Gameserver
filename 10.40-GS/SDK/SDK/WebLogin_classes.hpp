...
static_assert(sizeof(UWebLogin_C) == 0x000348, "Wrong size on UWebLogin_C");
static_assert(offsetof(UWebLogin_C, UberGraphFrame) == 0x000320, "Member 'UWebLogin_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UWebLogin_C, Throbber) == 0x000328, "Member 'UWebLogin_C::Throbber' has a wrong offset!");
static_assert(offsetof(UWebLogin_C, WebContent) == 0x000330, "Member 'UWebLogin_C::WebContent' has a wrong offset!");
static_assert(offsetof(UWebLogin_C, BackAction) == 0x000338, "Member 'UWebLogin_C::BackAction' has a wrong offset!");
