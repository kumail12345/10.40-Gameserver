...
static_assert(sizeof(ABP_VictoryDrone_C) == 0x0002D8, "Wrong size on ABP_VictoryDrone_C");
...
static_assert(offsetof(ABP_VictoryDrone_C, SpawnEffect) == 0x000288, "Member 'ABP_VictoryDrone_C::SpawnEffect' has a wrong offset!");
