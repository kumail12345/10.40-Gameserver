...
static_assert(sizeof(UFortTwitchLogin_C) == 0x0002E8, "Wrong size on UFortTwitchLogin_C");
static_assert(offsetof(UFortTwitchLogin_C, UberGraphFrame) == 0x000280, "Member 'UFortTwitchLogin_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UFortTwitchLogin_C, NotSignedInBox) == 0x000288, "Member 'UFortTwitchLogin_C::NotSignedInBox' has a wrong offset!");
static_assert(offsetof(UFortTwitchLogin_C, SignedInBox) == 0x000290, "Member 'UFortTwitchLogin_C::SignedInBox' has a wrong offset!");
static_assert(offsetof(UFortTwitchLogin_C, SignInButton) == 0x000298, "Member 'UFortTwitchLogin_C::SignInButton' has a wrong offset!");
static_assert(offsetof(UFortTwitchLogin_C, SignInStatusSwitcher) == 0x0002A0, "Member 'UFortTwitchLogin_C::SignInStatusSwitcher' has a wrong offset!");
static_assert(offsetof(UFortTwitchLogin_C, SignOutButton) == 0x0002A8, "Member 'UFortTwitchLogin_C::SignOutButton' has a wrong offset!");
static_assert(offsetof(UFortTwitchLogin_C, TwitchIdEntry) == 0x0002B0, "Member 'UFortTwitchLogin_C::TwitchIdEntry' has a wrong offset!");
static_assert(offsetof(UFortTwitchLogin_C, NoLinkedAccountText) == 0x0002B8, "Member 'UFortTwitchLogin_C::NoLinkedAccountText' has a wrong offset!");
static_assert(offsetof(UFortTwitchLogin_C, OnRequestToolTipChange) == 0x0002D0, "Member 'UFortTwitchLogin_C::OnRequestToolTipChange' has a wrong offset!");
static_assert(offsetof(UFortTwitchLogin_C, bShowingError) == 0x0002E0, "Member 'UFortTwitchLogin_C::bShowingError' has a wrong offset!");
