...
static_assert(sizeof(UGCN_Athena_Item_SuperDingo_Spawned_C) == 0x0001A8, "Wrong size on UGCN_Athena_Item_SuperDingo_Spawned_C");
static_assert(offsetof(UGCN_Athena_Item_SuperDingo_Spawned_C, Debug) == 0x0001A0, "Member 'UGCN_Athena_Item_SuperDingo_Spawned_C::Debug' has a wrong offset!");
